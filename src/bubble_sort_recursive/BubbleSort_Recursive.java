public class BubbleSort_Recursive {
    ...
    public double[] sort(double []inputList, int n){
        ...
        return sort(inputList, n-1);
    }

    public double[] sort(double []inputList){
    ...
    public static void testCases(){
        ...
        double []testList;
        BubbleSort_Recursive bubblesort = new BubbleSort_Recursive();
    ...
    public static void main(String []args) {
        BubbleSort_Recursive.testCases();
    }
